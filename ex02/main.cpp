...
/*   Updated: 2023/03/17 16:34:11 by vfuhlenb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main() {
	...
	std::cout << "\n----TEST 1---- CONSTRUCTION -----\n" << std::endl;
	{
		...
		// const AAnimal    *newAnimal = new AAnimal(*animal[1]); // Pure Abstract Class
		...
		// newAnimal->makeSound(); // Pure Abstract Class

		std::cout << "\n----TEST 1---- DECONSTRUCT -----\n" << std::endl;

		for (int i = 0; i < ANIMALS; i++)
			delete animal[i];
		// delete newAnimal; // Pure Abstract Class
	}
	std::cout << "\n----TEST 1---- COMPLETED -----\n" << std::endl;
